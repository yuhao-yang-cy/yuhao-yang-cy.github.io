...
{% include figure.liquid loading="eager" path="assets/img/deep/C4W4_style_transfer.jpg" title="Nerual Style Transfer" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/deep/C4W4_viz_cnns.jpg" title="Layers of a CNN" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/deep/C4W4_NST_Unrolling.jpg" title="Unrolling a 3D Layer" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/deep/C4W4_NST_GM.jpg" title="Gram Matrix Multiplication" class="img-fluid rounded z-depth-1" %}
...
{% include figure.liquid loading="eager" path="assets/img/deep/C4W4_antelope_NST.jpg" title="Style Transfer with Customised Images" class="img-fluid rounded z-depth-1" %}
